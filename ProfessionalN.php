    ...
    <body>
        ...
        <div id = "clients">
          <table style = "float: right;" WIDTH = 200>
            ...
            <tr>
              <td id = "addClient"> 
                Type in clients username to add:
                <form method = "post">
                    <input type = "text" name = "addClient" id = "addClient" style = "width: 10vw; height: 1.2rem;">
                    <input id = "addExerciseButton" type = "submit" value = "Add Client">
                </form>
                </td>
            </tr>
          </table>
        ...
        <div id = "addAppointment"> 
          ...
          <form method = "post">
                <input type = "time" name = "addAppoint" id = "addAppoint" style = "width: 7vw; height: 1.2rem;">
